...
2 Arquivos
- lista.h: define os protótipos e os cabeçalhos que vão ser utilizados no arquivo de implementação
- sll.c: Implementação das funções
- SLLMain.c: Arquivo principal, função main com todo o programa utilizando as funções descritas no enunciado
- SLLMain.exe: Arquivo executável gerado após a compilação do código.

 Formas de executar:

Executando o arquivo utilizando a IDE (preferencialmente CLion) utilizando a forma genérica de execução
Clique duplo no arquivo executável SLLMain, disponível na pasta em que se encontra esse readme
