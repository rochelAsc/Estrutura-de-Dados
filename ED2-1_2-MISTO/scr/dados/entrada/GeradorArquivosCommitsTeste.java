...
public class GeradorArquivosCommitsTeste {
    ...
    public static void main(String[] args) {
        ...
        File diretorio = new File("ED2-1_2-MISTO/scr/dados/saida");
        if (!diretorio.exists()) {
            diretorio.mkdir();
        }
        ...
        salvarCommitsJSON(commits1000, "ED2-1_2-MISTO/scr/dados/saida/commits_1000.json");
        
        List<Commit> commits10000 = gerarCommits(10000, 200);
        salvarCommitsJSON(commits10000, "ED2-1_2-MISTO/scr/dados/saida/commits_10000.json");
        
        List<Commit> commits100000 = gerarCommits(100000, 1000);
        salvarCommitsJSON(commits100000, "ED2-1_2-MISTO/scr/dados/saida/commits_100000.json");
        
        // Gerar cenário crítico
        List<Commit> commitsCriticos = gerarCenarioCritico(500);
        salvarCommitsJSON(commitsCriticos, "ED2-1_2-MISTO/scr/dados/saida/commits_criticos.json");
        
        // Gerar arquivo de estatísticas
        gerarArquivoEstatisticas();
        
        System.out.println("\nArquivos gerados com sucesso na pasta 'ED2-1_2-MISTO/scr/dados/saida/'");
    ...
    public static void gerarArquivoEstatisticas() {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter("ED2-1_2-MISTO/scr/dados/saida/estatisticas.txt"))) {
            ...
            System.out.println("Estatísticas geradas: ED2-1_2-MISTO/scr/dados/saida/estatisticas.txt");
        } catch (IOException e) {
